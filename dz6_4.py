...
def _is_leap(year: int) -> bool: # защищенная функция
    return year % 4 == 0 and year % 100 != 0 or year % 400 == 0

def is_valid_data(date: str) -> bool:
...
if __name__ == '__main__':
    date_to_prov = '11.04.101010'
    print(is_valid_data(date_to_prov))
    date_to_prov = '11.13.2100'
    print(is_valid_data(date_to_prov))
    date_to_prov = '32.04.2100'
    print(is_valid_data(date_to_prov))
    date_to_prov = '11.04.2100'
    print(is_valid_data(date_to_prov))
    date_to_prov = '29.02.2000'
    print(is_valid_data(date_to_prov))
    date_to_prov = '29.02.2002'
    print(is_valid_data(date_to_prov))
